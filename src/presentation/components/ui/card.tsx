...
export function Card({
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/80 p-6 shadow-lift shadow-slate-900/5 backdrop-blur-xl transition duration-300 hover:shadow-lift dark:border-slate-700/80 dark:bg-slate-900/80 dark:shadow-slate-950/30 sm:p-7">
